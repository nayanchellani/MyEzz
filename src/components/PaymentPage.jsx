    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
        <div className="text-center space-y-4">
          <div className="bg-red-100 dark:bg-red-900/20 p-6 rounded-full inline-flex mb-2">
          ...
          <button
            onClick={() => navigate("/")}
            className="mt-4 px-8 py-3 bg-[#E23744] dark:bg-[#990000] hover:opacity-90 text-white font-bold rounded-xl shadow-lg"
          >
            Browse Menu
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8 flex items-center justify-center transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 relative z-10">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 h-fit">
          {/* Header Section */}
          <div className="bg-gradient-to-br from-[#E23744] to-[#c42f3c] dark:from-[#990000] dark:to-[#7a0000] p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-red-100 text-sm mt-1 opacity-90">Select how you'd like to pay</p>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8 space-y-6">
            <div className="space-y-4">
              ...
              <div
                ...
                className={`relative flex items-center p-4 rounded-2xl border-2 cursor-pointer group
                  ${method === "card"
                    ? "border-[#E23744] dark:border-[#990000] bg-red-50/50 dark:bg-red-900/20 shadow-lg"
                    : "border-gray-100 dark:border-gray-700 hover:border-[#E23744]/50 dark:hover:border-[#990000]/50 hover:bg-gray-50 dark:hover:bg-gray-800/50"
                  }`}
              >
                <div className={`p-3.5 rounded-xl mr-4 ${method === "card" ? "bg-[#E23744] dark:bg-[#990000] text-white shadow-md" : "bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400"}`}>
                  <CreditCard size={24} />
                </div>
                <div className="flex-1">
                  <h4 className={`font-bold text-base ${method === "card" ? "text-[#E23744] dark:text-[#990000]" : "text-gray-800 dark:text-gray-200"}`}>Pay Online</h4>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">UPI, Cards, Netbanking</p>
                </div>
                {method === "card" && (
                  <div className="bg-[#E23744] dark:bg-[#990000] rounded-full p-1">
              ...
              >
                <div className={`p-3.5 rounded-xl mr-4 ${method === "cod" ? "bg-[#E23744] dark:bg-[#990000] text-white shadow-md" : "bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400"}`}>
                  <Wallet size={24} />
                </div>
                <div className="flex-1">
                  <h4 className={`font-bold text-base ${method === "cod" ? "text-[#E23744] dark:text-[#990000]" : "text-gray-800 dark:text-gray-200"}`}>Cash on Delivery</h4>
            ...
            <button
              ...
              className={`w-full py-4 text-lg font-bold rounded-2xl shadow-xl
                ${loading
                  ...
                  : "bg-[#E23744] dark:bg-[#990000] hover:opacity-90 text-white shadow-red-200/50 dark:shadow-red-900/30"
                }`}
            >
              {loading ? (
          ...
          <div className="p-6 sm:p-8 bg-gray-50/50 dark:bg-gray-800/50">
                ...
                return (
                  <div key={`${item.id}-${index}`} className="flex justify-between items-start py-3 border-b border-gray-100 dark:border-gray-700 last:border-0">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-[#E23744] dark:text-[#990000] mt-1 flex items-center gap-1">
                        <span>🍽️</span>
            ...
            <div className="mt-6 space-y-3 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex justify-between text-xl font-bold text-gray-900 dark:text-white pt-4 border-t border-gray-200 dark:border-gray-700">
                <span>Total</span>
                <span className="text-[#E23744] dark:text-[#990000]">₹{total}</span>
              </div>
            </div>
